...
<head>
  ...
  <title>Gestion des contraintes</title>
  ...
  <main id="main">
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Gestion des contraintes</h1>
              </div>
            </div>
          </div>
        </div>
	...
	<div class="container" data-aos="fade-up">
  			...
  			<tbody>
  				...
  				?>
  					<tr>
  						...
  						<td>
  							<?php if($con->check_ens($value->id_enseignant, $ids) == true){ $conn = $con->type_con($value->id_enseignant, $ids); echo "<b style='color: #ff1919;'>".$conn->type_contrainte."</b>"; }else{ echo "<b style='color: #00b300;'>Aucune</b>"; } ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  						</td>
                        <td>
                            <a href="..\Controlleur\add-contrainte.php?id_enseignant=<?php echo $value->id_enseignant; ?>" class="btn-sm btn-primary"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Modifier</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="color: white;" href="..\Controlleur\delete-contrainte.php?id_enseignant=<?php echo $value->id_enseignant; ?>" class="gradient btn-sm bg-danger bg-gradient"><i class="fa fa-close"></i>&nbsp;&nbsp;Supprimer</a>
                        </td>
  					</tr>
  				<?php
  					}
		...
		<div class="d-grid gap-2">
			<a href="..\Controlleur\affiche-planning.php" class="btn btn-primary">Terminer</a>
        </div>
  	</div>
	<br><br><br><br>
    <!-- ======= CTA Section ======= -->
