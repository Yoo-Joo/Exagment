...
<head>
  ...
  <title>Gestion des Planning</title>
  ...
  <main id="main">
	...
	<div class="container" data-aos="fade-up">
  			...
  			<div class="container-fluid">
    			<div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
      				<div class="navbar-nav">
        				...
        				<a class="nav-link active" href="..\Controlleur\affiche-planning.php" ><b>Planning</b></a>
      				</div>
    			</div>
  			</div>
		</nav>
  			...
  			<tbody>
  				...
  				?>
  					<tr>
  						...
  						<td><?php echo $value->type_session; ?></td>
  						<td><?php if($value->etat_session == "Actif"){ echo $_SESSION['actif']; }else{ echo $_SESSION['non actif']; } ?></td>
  						<td>
  							<a href="..\Controlleur\affiche-update-session.php?id_session=<?php echo $value->id_session; ?>" class="btn-sm btn-primary bg-gradient">Modifier</a>&nbsp;&nbsp;<a style="color: white;" href="..\Controlleur\affiche-planification.php?id_session=<?php echo $value->id_session; ?>" class="btn-sm btn-primary bg-gradient">Planifications</a>&nbsp;&nbsp;<a style="color: white;" href="..\Controlleur\affiche-contrainte1.php?id_session=<?php echo $value->id_session; ?>" class="btn-sm bg-danger bg-gradient">Contraintes</a>
  						</td>
  					</tr>
  				<?php
  					}
		...
		<div class="d-grid gap-2">
			<a href="..\Controlleur\add-session.php" class="btn btn-primary">Ajouter session</a>
		</div>
	</div>
	<br><br><br><br>
    <!-- ======= CTA Section ======= -->
