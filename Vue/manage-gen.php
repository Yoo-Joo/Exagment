...
<head>
  ...
  <title>Génération des surveillances</title>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Génération des surveillances</h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <thead>
  			...
  			<tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="..\Controlleur\add-affectation.php?id_session=<?php echo $value->id_session; ?>" class="btn-sm btn-primary bg-gradient">Générer</a>
                    </td>
                </tr>
            <?php
                }
