...
<head>
  ...
  <title>Mise à jour de session</title>
...
<body>
  ...
  <main id="main">
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Mise à jour de session</h1>
              </div>
            </div>
          </div>
        </div>
	...
	<div class="container">
		<br><br>
		<br><br><br>
		<form method="post" action="..\Controlleur\update-session1.php">
			<div class="mb-3">
  				<label class="form-label"><b>Date début :</b></label>
  				<div class="col-16">
  					<?php //var_dump($session->date_debut); ?>
    			<input class="form-control" name="dated" type="date" value="<?php echo $session->date_debut; ?>" id="example-date-input">
  				</div>
			</div>
			<div class="mb-3">
  				<label class="form-label"><b>Date fin :</b></label>
  				<div class="col-16">
    			<input class="form-control" name="datef" type="date" value="<?php echo $session->date_fin; ?>" id="example-date-input">
  				</div>
			</div>
			<div class="mb-3">
  				...
  				<select name="anneeu" class="form-select" aria-label="Default select example">
  					<option hidden><?php echo $session->annee_universitaire; ?></option>
			...
			<div class="mb-3">
  				...
  				<div class="form-check form-check-inline">
  					<input class="form-check-input" type="radio" name="nomsession" id="inlineRadio1" value="Printemps/été" <?php if($session->nom_session == 'Printemps/été'){ echo 'checked';}else{'';} ?> required>
  					<label class="form-label" for="inlineRadio1">Printemps/été</label>
				</div>
				<div class="form-check form-check-inline">
  					<input class="form-check-input" type="radio" name="nomsession" id="inlineRadio1" value="Automne/Hiver" <?php if($session->nom_session == 'Automne/Hiver'){echo 'checked';}else{'';} ?> required>
			...
			<div class="mb-3">
  				...
  				<div class="form-check form-check-inline">
  					<input class="form-check-input" type="radio" name="typesession" id="inlineRadio1" value="Normale" <?php if($session->type_session == 'Normale'){ echo 'checked';}else{'';} ?> required>
  					<label class="form-label" for="inlineRadio1">Normale</label>
				</div>
				<div class="form-check form-check-inline">
  					<input class="form-check-input" type="radio" name="typesession" id="inlineRadio1" value="Rattrapage" <?php if($session->type_session == 'Rattrapage'){echo 'checked';}else{'';} ?> required>
			...
			<div class="mb-3">
  				...
  				<select name="etat" class="form-select" aria-label="Default select example">
  					<option hidden><?php echo $session->etat_session; ?></option>
  					<option>Actif</option>
			...
			<div class="mb-3">
				...
				<input style="color: white; background-color: #0275d8;" class="form-control btn btn-primary" type="submit" name="enregistrer" value="Enregistrer">		
			</div>
		</form>
	</div>
	<br><br><br><br>
