...
<head>
  ...
  <title>Mise à jour d'enseignant</title>
...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a style="text-decoration: none;" class="active"  href="#"><span>Gestion de</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a style="text-decoration: none;" class="active" href="../Controlleur/affiche-enseignant">Enseignants</a></li>
  ...
  <main id="main">
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Mise à jour d'enseignant</h1>
              </div>
            </div>
          </div>
        </div>
	...
	<br><br><br><br><br>
	<div class="container">
		<form method="post" action="..\Controlleur\update-enseignant1.php">
			<div class="mb-3">
			...
			<div class="mb-3">
  				<label class="form-label">Prènom enseignant :</label>
			...
			<div class="mb-3">
  				...
  				<!--<input type="text" name="dept" value="<?php //echo $dpt; ?>" class="form-control">-->
  				<select name="dept" class="form-select" aria-label="Default select example">
  					<option hidden><?php echo $enseignant["departement"]; ?></option>
			...
			<div class="mb-3">
  				<label class="form-label">Crèdit :</label>
  				<input type="number" name="crd" value="<?php echo $enseignant["credit"]; ?>" class="rounded form-control">
			</div>
			<div class="mb-3">
  				<label class="form-label">Etat Enseignant :</label>
  				<select name="etat" class="form-select" aria-label="Default select example">
  					<option hidden><?php echo $enseignant["etat_enseignant"]; ?></option>
  					<option>Actif</option>
			...
			<div class="mb-3">
				...
				<input style="color: white; background-color: #0275d8;" class="form-control color btn btn-primary rounded" type="submit" name="enregistrer" value="Enregistrer">		
			</div>
		</form>
	</div>
	<br><br><br><br>
