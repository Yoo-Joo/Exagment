...
<head>
  ...
  <title>Mise à jour de local</title>
...
<body>
  ...
  <main id="main">
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Mise à jour de local</h1>
              </div>
            </div>
          </div>
        </div>
	...
	<br><br><br><br><br>
	<div class="container">
		<form method="post" action="..\Controlleur\update-local1.php">
			<div class="mb-3">
  				<label class="form-label">Type local :</label>
  				<select name="name" class="form-select" aria-label="Default select example">
  					<option hidden><?php echo $locaux["nom_local"]; ?></option>
  					<option>Amphi</option>
  					<option>Salle</option>
				</select>
  				<!--<input type="text" name="name" value="<?php //echo $locaux["nom_local"]; ?>" class="form-control">-->
			</div>
			<div class="mb-3">
  				<label class="form-label">Ref local :</label>
  				<input type="text" name="ref" value="<?php echo $locaux["ref_local"]; ?>" class="rounded form-control">
			</div>
			<div class="mb-3">
  				<label class="form-label">Capacite :</label>
  				<input type="number" name="capacite" value="<?php echo $locaux["capacite"]; ?>" class="rounded form-control">
			</div>
			<div class="mb-3">
  				<label class="form-label">Nombre maximum des etudiants :</label>
  				<input type="number" name="nb_et" value="<?php echo $locaux["nbr_max_et"]; ?>" class="rounded form-control">
			</div>
			<div class="mb-3">
  				<label class="form-label">Nombre maximum des enseignants :</label>
  				<input type="number" name="nb_en" value="<?php echo $locaux["nbr_max_en"]; ?>" class="rounded form-control">
			</div>
			<div class="mb-3">
  				<label class="form-label">Etat local :</label>
  				<!--<div class="form-check form-switch"><input name="etat" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" value="<?php //echo $locaux["etat_local"]; ?>" <?php //echo ($locaux["etat_local"])?"checked":""; ?>></div>-->
  				<select name="etat" class="form-select" aria-label="Default select example">
  					<option hidden><?php echo $locaux["etat_local"]; ?></option>
  					<option>Actif</option>
			...
			<div class="mb-3">
				...
				<input style="color: white; background-color: #0275d8;" class="form-control btn btn-primary rounded" type="submit" name="enregistrer" value="Enregistrer">		
			</div>
		</form>
	</div>
	<br><br><br><br>
