	...
	<div class="container" data-aos="fade-up">
  			...
  			<div class="container-fluid">
    			<div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
      				<div class="navbar-nav">
        				<a class="nav-link active" aria-current="page" href="..\Controlleur\affiche-enseignant.php"><b>Enseignant</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        				<a class="nav-link" href="..\Controlleur\affiche-local.php"><b>Local</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table class="table table-striped">
  			...
  			<tbody>
  				...
  				?>
  					<tr>
  						<td><?php echo $value->id_enseignant; ?></td>
  						<td><?php echo $value->nom_enseignant; ?></td>
  						<td><?php echo $value->prenom_enseignant; ?></td>
  						<td><?php echo $value->departement; ?></td>
  						<td><?php echo $value->credit; ?></td>
  						<td><?php if($value->etat_enseignant == "Actif"){ echo $_SESSION['actif']; }else{ echo $_SESSION['non actif']; } ?></td>
  						<td>
  							<a style="color: white;" href="..\Controlleur\affiche-update-enseignant.php?id_enseignant=<?php echo $value->id_enseignant; ?>" class="gradient btn-sm bg-primary bg-gradient">Modifier</a>&nbsp;&nbsp;<a style="color: white;" href="..\Controlleur\delete-enseignant.php?id_enseignant=<?php echo $value->id_enseignant; ?>" class="gradient btn-sm bg-danger bg-gradient">Supprimer</a>
  						</td>
  					</tr>
  				<?php
  					}
		...
		<div class="d-grid gap-2">
			<a href="..\Controlleur\add-enseignant.php" class="btn btn-primary">Ajouter enseignant</a>
		</div>
	</div>
	<br><br><br><br>
    <!-- ======= CTA Section ======= -->
