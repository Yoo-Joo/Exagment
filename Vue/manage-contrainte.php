  			...
  			<tbody>
  				...
  				?>
  					<tr>
  						...
  						<td><?php if($value->etat_enseignant == "Actif"){ echo $_SESSION['actif']; } ?></td>
  						<td>
  							&nbsp;&nbsp;<a href="..\Controlleur\add-contrainte.php?id_enseignant=<?php echo $value->id_enseignant; ?>" class="btn-sm btn-primary">Contrainte</a>
  						</td>
