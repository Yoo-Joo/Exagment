...
<head>
  ...
  <title>Gestion des Planifications</title>
...
<style>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="../Controlleur/admin-home">Exagement</a></h1>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Gestion des Planifications</h1>
              </div>
            </div>
          </div>
        </div>
	...
	<div class="container" data-aos="fade-up">
		...
		<table class="table table-striped">
  			...
  			<tbody>
  				...
  				?>
  					<tr>
  						<td><?php echo $value->id_planification; ?></td>
  						<td><?php echo $value->date_pla; ?></td>
  						<td><?php echo $value->demi_journee_pla; ?></td>
  						<td><?php echo $value->filiere; ?></td>
  						<td><?php echo $value->semestre; ?></td>
              <td><?php echo $value->matiere; ?></td>
  						<td>
  							&nbsp;&nbsp;<a href="..\Controlleur\affiche-update-planification.php?id_planification=<?php echo $value->id_planification; ?>" class="gradient btn-sm btn-primary bg-gradient">Modifier</a>&nbsp;&nbsp;<a style="color: white;" href="..\Controlleur\delete-planification.php?id_planification=<?php echo $value->id_planification; ?>?id_session=<?php echo $_GET['id_session'] ?>" class="gradient btn-sm bg-danger bg-gradient">Supprimer</a>
  						</td>
  					</tr>
  				<?php
  					}
		...
		<div class="d-grid gap-2">
			<a href="..\Controlleur\affiche-planning.php" class="btn btn-primary">Ajouter planification</a>
        </div>
  	</div>
	<br><br><br><br>
    <!-- ======= CTA Section ======= -->
