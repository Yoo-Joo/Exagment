...
<head>
  ...
  <title>Affichage des sessions</title>
  ...
  <main id="main">
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Affichage des sessions</h1>
              </div>
            </div>
          </div>
        </div>
	...
	<div class="container" data-aos="fade-up">
            ...
            <thead>
  			...
  			<tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="..\Controlleur\affiche-aff.php?id_session=<?php echo $value->id_session; ?>" class="btn-sm bg-gradient btn-primary">Modifier</a>&nbsp;&nbsp;&nbsp;<a href="..\Controlleur\list-affectation.php?id_session=<?php echo $value->id_session; ?>" class="btn-sm bg-gradient btn-primary">Afficher</a>
                    </td>
                </tr>
            <?php
                }
		...
		<div class="d-grid gap-2">
			<a href="..\Controlleur\admin-home.php" class="btn btn-primary">Terminer</a>
        </div>
  	</div>
	<br><br><br><br>
    <!-- ======= CTA Section ======= -->
